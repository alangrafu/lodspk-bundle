...
class HTTPStatus{
  ...
  public static function send405($uri){
    ...
    $alt = "LODSPeaKr does not allow this request method ($uri) for this resource ";
  	echo HTTPStatus::_getContent("405", $alt);
  	exit(0);
  }
  ...
  public static function send409($msg){
    header("HTTP/1.0 409 Conflict");
    $alt = $msg;
  	echo HTTPStatus::_getContent("409", $alt);
  	exit(0);
  }
  ...
  public static function send502($msg){
  	header("HTTP/1.0 502 Bad Gateway");
  	$alt = $msg;
  	echo HTTPStatus::_getContent("502", $alt);
  	exit(0);
  }
